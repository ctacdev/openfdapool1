...
A Freeform Jenkins project was created and configured to montior the github repo where the project code resides. Since this was a private repo, an SSH keypair was generated on github to allow jenkins access to the repo (read-only). 
...
Automated deployment (continuous delivery) is implemented with a second Jenkins project targeted specifially at release duties. The setup is identical to the development project with two exceptions:
